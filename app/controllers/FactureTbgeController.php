...
class FactureTbgeController extends \BaseController {
    ...
    public function create()
    {
      ...
      $compteurs['espacevert'] = DB::select("select compteur.CompteurID,  compteur.Nom,  energie.Nom as Energie,  compteur.Reference,  compteur.Localisation, espacevert.Nom as Patrimoine FROM compteur LEFT JOIN energie  ON (compteur.EnergieID=energie.EnergieID and compteur.BaseID=energie.BaseID ) INNER JOIN compteurespaceverts  ON (compteur.CompteurID=compteurespaceverts.CompteurID and compteur.BaseID=compteurespaceverts.BaseID ) INNER JOIN espacevert  ON (espacevert.EspacevertID=compteurespaceverts.EspacevertID and espacevert.BaseID=compteurespaceverts.BaseID ) WHERE compteur.Clos=0 AND compteur.BaseID='".$baseid."' order by Nom");
    ...
    public function store(){
      ...
      $validation = Validator::make(\Input::all(), 
        ...
        array(
          'CompteurID.required' => "Merci de sélectionner le compteur",
