...
{{-- Page title --}}
@section('title') Créer un budget et une fréqeuntation annuelle pour le maitre d'ouvrage @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Créer un budget et une fréquentation annuelle pour un maitre d'ouvrage </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if ( $errors->count() > 0 )
                                ...
                                @endforeach
                            @endif
                            {{ Form::open(array('url' => URL::to('moan') , 'role' => 'form')) }}
