...
{{-- Page title --}}
@section('title') Validation des postes d'éclairage à importer @stop
...
$(document).ready(function() {
    oTable = $('#dataTables-eclairages').dataTable({
        "dom": 'T<"clear">lfrtip',
        "tableTools": {
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Postes d'éclairage à importer</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(array('url' => URL::to('tbge/patrimoine/eclairage/import/csv/doimport') , 'role' => 'form' )) }}
