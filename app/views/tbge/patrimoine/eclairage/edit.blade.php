...
{{-- Page title --}}
@section('title') Modifier un poste d'éclairage @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Mise-à-jour des informations du poste d'éclairage </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if ( $errors->count() > 0 )
                                ...
                                @endforeach
                            @endif
                            {{ Form::model($eclairage, array('route' => array('tbge.patrimoine.eclairage.update', $eclairage->EclairageID), 'method' => 'put', 'role' => 'form')) }}
