...
{{-- Page title --}}
@section('title') Validation des points d'arrivée d'eau à importer @stop
...
$(document).ready(function() {
    oTable = $('#dataTables-arriveeaux').dataTable({
        "dom": 'T<"clear">lfrtip',
        "tableTools": {
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Points d'arrivée d'eau à importer</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Consultation de la liste des points d'arrivée d'eau à importer dans la base de données
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(array('url' => URL::to('tbge/patrimoine/arriveeau/import/csv/doimport') , 'role' => 'form' )) }}
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-arriveeaux">
                                <thead>
                                    <tr>
                                        <th>
