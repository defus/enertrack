...
{{-- Page title --}}
@section('title') Modifier un point d'arrivée d'eau @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Mise-à-jour des informations du point d'arrivée d'eau </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if ( $errors->count() > 0 )
                                ...
                                @endforeach
                            @endif
                            {{ Form::model($arriveeau, array('route' => array('tbge.patrimoine.arriveeau.update', $arriveeau->ArriveeauID), 'method' => 'put', 'role' => 'form')) }}
