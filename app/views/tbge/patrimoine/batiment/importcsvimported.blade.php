...
{{-- Page title --}}
@section('title') Validation des batiments à importer @stop
...
$(document).ready(function() {
    oTable = $('#dataTables-batiments').dataTable({
        "dom": 'T<"clear">lfrtip',
        "tableTools": {
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Batiments à importer</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Consultation de la liste des batiments à importer dans la base de données
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(array('url' => URL::to('tbge/patrimoine/batiment/import/csv/doimport') , 'role' => 'form' )) }}
