...
{{-- Page title --}}
@section('title') Validation des espaces verts à importer @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Espaces verts à importer</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Liste des espaces verts à importer dans la base de données
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(array('url' => URL::to('tbge/patrimoine/espacevert/import/csv/doimport') , 'role' => 'form' )) }}
