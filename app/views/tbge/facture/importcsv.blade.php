...
{{-- Page title --}}
@section('title') Importer les factures depuis un fichier CSV @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Importer les factures depuis un fichier CSV </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @endif
                            {{ Form::open(array('url' => URL::to('tbge/facture/import/csv/post') , 'role' => 'form', 'files' => true)) }}
