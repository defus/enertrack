                        ...
                        <div class="col-lg-12">
                            ...
                            {{ Form::open(array('url' => URL::to('tbge/facture') , 'role' => 'form')) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="bigdrop form-control" id="compteur" name="CompteurID" value="{{Input::old('CompteurID')}}" />
                                </div>
                                <div class="form-group @if($errors->first('Debutperiode') != '')) has-error @endif">
                                    <label>Du *</label>
                                    <input type="text" name="Debutperiode" id="Debutperiode" value="{{Input::old('Debutperiode')}}" class="form-control">
                                    {{ $errors->first('Debutperiode', '<span class="error">:message</span>' ) }}
                                </div>
                                <div class="form-group @if($errors->first('Finperiode') != '')) has-error @endif">
                                    <label>Au *</label>
                                    <input type="text" name="Finperiode" id="Finperiode" value="{{Input::old('Finperiode')}}" class="form-control">
