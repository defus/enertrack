...
{{-- Page title --}}
@section('title') Validation des factures à importer @stop
...
$(document).ready(function() {
    oTable = $('#dataTables-factures').dataTable({
        "dom": 'T<"clear">lfrtip',
        "tableTools": {
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Liste des factures à importer dans la base de données
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(array('url' => URL::to('tbge/facture/import/csv/doimport') , 'role' => 'form' )) }}
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-factures">
                                <thead>
                                    <tr>
                                        <th>
