...
{{-- Page title --}}
@section('title') Importer les compteurs depuis un fichier CSV @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Importer les compteurs depuis un fichier CSV </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @endif
                            {{ Form::open(array('url' => URL::to('tbge/compteur/import/csv/post') , 'role' => 'form', 'files' => true)) }}
