                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if ( $errors->count() > 0 )
                                ...
                                @endforeach
                            @endif
                            {{ Form::model($facture, array('route' => array('facture.update', $facture->FactureID), 'method' => 'put', 'role' => 'form')) }}
                            <fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::number('Prixunitaire', Input::old('Prixunitaire'), array('class' => 'form-control', 'placeholder' => "Le champ Prix unitaire doit être composé de chiffres") ) }}
                                </div>
                                <div class="form-group">
                                    <label>HP</label>
