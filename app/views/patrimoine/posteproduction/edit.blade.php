                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if ( $errors->count() > 0 )
                                ...
                                @endforeach
                            @endif
                            {{ Form::model($posteproduction, array('route' => array('patrimoine.posteproduction.update', $posteproduction->PosteproductionID), 'method' => 'put', 'role' => 'form')) }}
                                ...
                                <div>
                                    <label>Production theorique</label>
                                    {{ Form::number('Productiontheorique', Input::old('Productiontheorique'), array('class' => 'form-control') ) }}
                                </div>
                                <div>
                                    <label>Cout initial</label>
                                    {{ Form::number('Coutinitial', Input::old('Coutinitial'), array('class' => 'form-control') ) }}
                                </div>
                                <div class="form-group">
