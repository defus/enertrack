...
{{-- Page title --}}
@section('title') Modifier un @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Mise-à-jour des informations du poste </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if ( $errors->count() > 0 )
                                ...
                                @endforeach
                            @endif
                            {{ Form::model($autreposte, array('route' => array('patrimoine.autreposte.update', $autreposte->AutreposteID), 'method' => 'put', 'role' => 'form')) }}
